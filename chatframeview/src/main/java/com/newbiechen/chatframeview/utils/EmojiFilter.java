...
public class EmojiFilter implements InputFilter {
    ...
    private OnEmojiFilterListener mListener;
    ...
    public CharSequence filter(CharSequence source, int start, int end, Spanned dest, int dstart,
        ...
        if (filterSet.contains(source.toString())) {
            if (mListener != null){
                mListener.onEmojiFilter(source.toString());
            }
            return "";
        }
        return source;
    ...
    public interface OnEmojiFilterListener{
        void onEmojiFilter(String code);
    }

    public void setFilterListener(OnEmojiFilterListener listener){
        mListener = listener;
    }

    public static boolean isEmoji(int code){
        return filterSet.contains(Integer.toHexString(code));
    }
}